Navigate to HLLYAS001_CSC3002_OS2_PART3/molecule/
...
5. To check git repository, execute 'git log' in the terminal when in /
   HLLYAS001_CSC3002_OS3_PART3 directory
6. Execute 'git remote -v' to check git push/upload and follow 'origin3' link to check for 	
